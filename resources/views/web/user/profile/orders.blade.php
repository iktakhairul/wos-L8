        ...
        <div class="table-responsive">
            <table class="table table-hover">
                <tbody>
                    <tr>
                        <td width="65">
                            <img src="{{ asset('web/images/items/1.jpg') }}" class="img-xs border">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <img src="{{ asset('web/images/items/2.jpg') }}" class="img-xs border">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <img src="{{ asset('web/images/items/3.jpg') }}" class="img-xs border">
                        </td>
                        <td>
