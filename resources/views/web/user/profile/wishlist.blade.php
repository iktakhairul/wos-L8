            ...
            <div class="row">
                <div class="col-md-6">
                    <figure class="itemside mb-4">
                        <div class="aside"><img src="{{ asset('web/images/items/1.jpg') }}" class="border img-md">
                        </div>
                        <figcaption class="info">
                            ...
                            <a href="#" class="btn btn-danger btn-sm" data-toggle="tooltip" title=""
                ...
                <div class="col-md-6">
                    <figure class="itemside mb-4">
                        <div class="aside"><img src="{{ asset('web/images/items/2.jpg') }}" class="border img-md">
                        </div>
                        <figcaption class="info">
                ...
                <div class="col-md-6">
                    <figure class="itemside mb-4">
                        <div class="aside"><img src="{{ asset('web/images/items/3.jpg') }}" class="border img-md">
                        </div>
                        <figcaption class="info">
