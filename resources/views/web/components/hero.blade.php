            ...
            <div class="row">
                <aside class="col-lg col-md-3 flex-lg-grow-0">
                    <nav class="nav-home-aside">
                        <h6 class="title-category">MY MARKETS <i class="d-md-none icon fa fa-chevron-down"></i>
                        </h6>
                ...
                <div class="col-md d-none d-lg-block flex-grow-1">
                    <aside class="special-home-right">
                        ...
                        <div class="card-banner border-bottom">
                            ...
                            <img src="web/images/items/1.jpg" height="80" class="img-bg">
                        </div>
                        ...
                        <div class="card-banner border-bottom">
                            ...
                            <img src="web/images/items/2.jpg" height="80" class="img-bg">
                        </div>
                        ...
                        <div class="card-banner border-bottom">
                            ...
                            <img src="web/images/items/6.jpg" height="80" class="img-bg">
                        </div>
