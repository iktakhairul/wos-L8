    ...
    <section class="header-main border-bottom p-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white" style="min-height: 100px;">
            <div class="container">
                ...
                <a href="{{ route('test.baby') }}" class="brand-wrap navbar-brand">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <div class="widget-header mr-3">
                                <a href="{{ route('test.baby') }}" class="widget-view nav-link @if (request()->routeIs(['baby'])) active-hover @endif">Baby Profile - শিশুর প্রোফাইল</a>
                            </div>
                        </li>
                        <li class="nav-item">
                            <div class="widget-header mr-3">
                                <a href="{{ route('test.diet-chart') }}" class="widget-view nav-link @if (request()->routeIs(['diet-chart'])) active-hover @endif">Diet Chart - গর্ভকালীন ডায়েট চার্ট</a>
                            </div>
                        </li>
                        @endauth
