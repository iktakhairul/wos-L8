...
<div class="container-fluid mt-4">
    ...
    <div class="row mt-2">
        <div class="col-md-12" >
            <h6 class="pl-2">{{ now()->format('F j, Y')}} - @if($babyAge){{$babyAge->m}} months and {{$babyAge->d}} days @else  @endif</h6>
            @if($babyAge->m+1 == 1)
            <p class="p-2 pb-0">এ মাসে ফলিক এসিড বা ফলেট বাচ্চার স্নায়ুতন্ত্রের জন্য খুব খুব জরুরি। তবে অনেকেই টের পান না এত জলদি। তাই সন্তান গ্রহণে ইচ্ছুক নারীর সব সময়ই ফলেট সমৃদ্ধ খাবার, যেমন- সবুজ শাক সবজি, ডাল, বাদাম ইত্যাদি খাওয়া উচিত।</p>
            ...
            @endif
            <p class="pl-2 text-warning">নোটঃ একজন স্বাভাবিক ওজনের নারীর ক্ষেত্রে প্রেগন্যান্সির প্রথম ছয় মাস পর্যন্ত প্রায় ১ কেজি করে আর পরের মাস গুলোয় প্রায় ২ কেজি করে ওজন বাড়ার কথা। এই হারের থেকে কম বেশি হলে খাবারের অনুপাত সেভাবে ঠিক করে নিতে হবে।</p>
        </div>
    </div>
</div>
