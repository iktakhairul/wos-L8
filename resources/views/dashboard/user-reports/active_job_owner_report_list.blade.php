...
@section('title','Job Owner Report List')

@section('breadcrumbs')

    <li class="breadcrumb-item active"><a href="#">Job Owner Report List</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <h4 class="page-header">
                <i class="fa fa-user"></i> Job Owner Report List
            </h4>
        </div>
    </div>
